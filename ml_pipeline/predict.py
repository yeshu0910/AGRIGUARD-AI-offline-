...
class CropDiseasePredictor:
    ...
    def __init__(self, model_path: Optional[Path] = None, classes_path: Optional[Path] = None):
        """
    ...
    def predict(
        self, image: Union[Image.Image, Path, str], return_top_k: int = 5
    ) -> Dict[str, any]:
        """
    ...
    def predict_batch(self, images: List[Union[Image.Image, Path, str]]) -> List[Dict[str, any]]:
        """
    ...
    def generate_saliency_map(
        self, image: Union[Image.Image, Path, str], class_idx: Optional[int] = None
    ) -> Image.Image:
        """
...
def create_predictor(
    model_path: Optional[Path] = None, classes_path: Optional[Path] = None
...
def main():
    ...
    parser.add_argument(
        "--output", type=Path, default=None, help="Path to save Grad-CAM visualization"
    )
