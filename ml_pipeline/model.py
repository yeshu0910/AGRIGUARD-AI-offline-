...
class CropDiseaseModel:
    ...
    def build_model(self, freeze_base: bool = True) -> keras.Model:
        ...
        self.base_model = EfficientNetB0(
            include_top=False, weights=self.config.model.WEIGHTS, input_tensor=x, pooling="avg"
        )
    ...
    def _combine_histories(
        self, history1: keras.callbacks.History, history2: keras.callbacks.History
...
def create_model(
    num_classes: int, input_shape: Tuple[int, int, int] = (224, 224, 3)
) -> CropDiseaseModel:
    """
